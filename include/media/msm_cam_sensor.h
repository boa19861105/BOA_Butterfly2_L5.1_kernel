...
enum msm_sensor_power_seq_type_t {
	...
	SENSOR_GPIO,
	SENSOR_VREG,
	SENSOR_VREG_NCP6924,	/* HTC_START Steven.CW_Wu 20131206 - porting ov13850 and NCP6924 */
	SENSOR_I2C_MUX,
//HTC_START
	SENSOR_CHECK_CAMID,
//HTC_END
...
//HTC_END
	SENSOR_GPIO_MAX,
/* When increasing this enum size, must check the gpio_num[] array size in arch/arm/mach-msm/include/mach/board.h */
};
...
struct msm_sensor_info_t {
	...
	//HTC_START
	uint32_t  sensor_mirror_flip; //0 for default setting, 1 to enalbe mirror-flip by sensor setting (assume mount angle of main is 90, front is 270)
	uint8_t  OTP_INFO[5];
	uint8_t  fuse_id[4];
	//HTC_END
};
...
struct msm_rawchip2_cfg_data {
	...
	uint8_t yushan_sensor_status_line; // for Ilp0100_structSensorParams.StatusNbLines
	int channel_offset;
...
/*HTC_START, for actuator modulation*/
