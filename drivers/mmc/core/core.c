			...
			unsigned int to, unsigned int arg)
{
	...
	/*
	 * worakaround for Hynix spec4.5 emmc, the emmc component has Dicard/Trim issue.
	 * If it hit the bug, device will meet init failed .
	 * Hynix suggests that Dummy Read can avoid the issue.
	 */
